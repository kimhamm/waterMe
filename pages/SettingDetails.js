...
export default function SettingDetails(props) {
  ...
  const data_agreements = [
    {
      itemTitle: "Privacy Policy Agreement",
      itemImg: require("../assets/glass-svgrepo-com.svg"),
    },
    {
  ...
  const data_accountManagement = [
    ...
    {
      itemTitle: "Reset Data",
      itemImg: require("../assets/glass-svgrepo-com.svg"),
    },
    {
      itemTitle: "Withdraw Membership",
      itemImg: require("../assets/glass-svgrepo-com.svg"),
    },
  ];
  ...
  if (settingsTitle === "Profile Setting") {
    ...
    content = (
      <List
        listTitle="Account"
        listData={data_accountManagement}
        toggleModal={toggleModal}
      />
    );
    isStateUpdated = false;
